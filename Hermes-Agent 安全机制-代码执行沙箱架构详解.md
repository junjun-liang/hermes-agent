...
- 核心实现：[tools/code\_execution\_tool.py](tools/code_execution_tool.py)（1400+ 行）
- 沙箱执行脚本：[tools/sandbox\_runner.py](tools/sandbox_runner.py)（内部文件）
...
- ANSI 剥离：[tools/ansi\_strip.py](tools/ansi_strip.py)（`strip_ansi`）
